var Module = (() => {
    ...
    return (async function (moduleArg = {}) {
        ...
        function createWasm() {
            ...
            function receiveInstance(instance, module) { wasmExports = instance.exports; wasmMemory = wasmExports["x"]; updateMemoryViews(); wasmTable = wasmExports["J"]; addOnInit(wasmExports["y"]); removeRunDependency("wasm-instantiate"); return wasmExports; }
        ...
        FS.staticInit();
        var wasmImports = { d: ___cxa_throw, o: __embind_register_bigint, s: __embind_register_bool, r: __embind_register_emval, f: __embind_register_float, b: __embind_register_integer, a: __embind_register_memory_view, g: __embind_register_std_string, c: __embind_register_std_wstring, t: __embind_register_void, m: __emscripten_fetch_free, l: __emscripten_memcpy_js, h: _abort, q: _emscripten_is_main_browser_thread, e: _emscripten_resize_heap, n: _emscripten_start_fetch, v: _environ_get, w: _environ_sizes_get, i: _fd_close, j: _fd_read, p: _fd_seek, k: _fd_write, u: _strftime_l };
