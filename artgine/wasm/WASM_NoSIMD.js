var Module = (() => {
    ...
    return (async function (moduleArg = {}) {
        ...
        function createWasm() {
            ...
            function receiveInstance(instance, module) { wasmExports = instance.exports; wasmMemory = wasmExports["o"]; updateMemoryViews(); wasmTable = wasmExports["s"]; addOnInit(wasmExports["p"]); removeRunDependency("wasm-instantiate"); return wasmExports; }
        ...
        FS.staticInit();
        var wasmImports = { b: ___cxa_throw, h: __emscripten_fetch_free, g: __emscripten_memcpy_js, d: _abort, j: _emscripten_is_main_browser_thread, c: _emscripten_resize_heap, i: _emscripten_start_fetch, m: _environ_get, n: _environ_sizes_get, e: _fd_close, f: _fd_read, k: _fd_seek, a: _fd_write, l: _strftime_l };
        var wasmExports = createWasm();
        var ___wasm_call_ctors = () => (___wasm_call_ctors = wasmExports["p"])();
        var _Init = Module["_Init"] = a0 => (_Init = Module["_Init"] = wasmExports["q"])(a0);
        var _Checker = Module["_Checker"] = a0 => (_Checker = Module["_Checker"] = wasmExports["r"])(a0);
