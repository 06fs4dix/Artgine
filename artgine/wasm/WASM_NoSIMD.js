var Module = (() => {
    ...
    return (async function (moduleArg = {}) {
        ...
        var wasmBinaryFile;
        if (Module["locateFile"]) {
            wasmBinaryFile = "WASM_NoSIMD.wasm";
            if (!isDataURI(wasmBinaryFile)) {
                wasmBinaryFile = locateFile(wasmBinaryFile);
            }
        }
        else {
            wasmBinaryFile = new URL("WASM_NoSIMD.wasm", import.meta.url).href;
        }
        ...
        function createWasm() {
            ...
            function receiveInstance(instance, module) { wasmExports = instance.exports; wasmMemory = wasmExports["o"]; updateMemoryViews(); wasmTable = wasmExports["w"]; addOnInit(wasmExports["p"]); removeRunDependency("wasm-instantiate"); return wasmExports; }
        ...
        FS.staticInit();
        var wasmImports = { c: ___cxa_throw, h: __emscripten_fetch_free, g: __emscripten_memcpy_js, d: _abort, j: _emscripten_is_main_browser_thread, a: _emscripten_resize_heap, i: _emscripten_start_fetch, m: _environ_get, n: _environ_sizes_get, e: _fd_close, f: _fd_read, k: _fd_seek, b: _fd_write, l: _strftime_l };
        ...
        var _Init = Module["_Init"] = a0 => (_Init = Module["_Init"] = wasmExports["r"])(a0);
        var _Checker = Module["_Checker"] = a0 => (_Checker = Module["_Checker"] = wasmExports["s"])(a0);
        var _SourceExcute = Module["_SourceExcute"] = (a0, a1) => (_SourceExcute = Module["_SourceExcute"] = wasmExports["t"])(a0, a1);
        var _SourceFree = Module["_SourceFree"] = a0 => (_SourceFree = Module["_SourceFree"] = wasmExports["u"])(a0);
