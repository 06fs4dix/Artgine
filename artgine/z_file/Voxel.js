...
import { SDF } from "./SDF";
import { Build, CMat, CVec3, CVec4, CMat3, Sam2DToColor, FloatToInt, IntToFloat, screenPos, discard, V2DivV2, V3AddV3, V3MulFloat, V4MulMatCoordi, Null, BranchBegin, BranchEnd, BranchDefault, Attribute, Sam2DArrToV4, Sam2DArrToMat, min, max, V3Len, V3SubV3, V3Nor, } from "./Shader";
import { bias, normalBias, PCF, shadowCount, shadowRate, shadowWrite, texture16f, shadowBottomCasP1, shadowFarCasP0, shadowLeftCasV2, shadowNearCasV0, shadowPointProj, shadowRightCasP2, shadowTopCasV1, jitter, shadowReadList, CalcShadow, } from "./Shadow";
var size = 100;
var worldMat = Null();
var viewMat = Null();
var projectMat = Null();
