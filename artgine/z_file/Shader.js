...
export class Sam2DV4 {
    constructor(_bindOff, _bufOff = -1) { }
    x;
    y;
}
...
export class Sam2DArrV4 {
    constructor(_bindOff, _bufOff = -1, _arrOff = 0) { }
    x;
    y;
    z;
}
export class Sam2DArrMat {
    constructor(_bindOff, _bufOff = -1, _arrOff = 0) { }
    x;
    y;
    z;
...
export var invocationID;
export var invocationCount;
...
export function Sam2DGradToColor(_number, _uv, _dx, _dy) { return new CVec4(0, 0, 0, 0); }
export function Sam2DLodToColor(_number, _uv, _lod) { return new CVec4(0, 0, 0, 0); }
export function Sam2DArrToColor(_number, _uv) { return new CVec4(0, 0, 0, 0); }
export function Sam2DArrGradToColor(_number, _uv) { return new CVec4(0, 0, 0, 0); }
...
export function Sam2DArrToV4(_uni, _off) { return new CVec4(0, 0, 0, 0); }
export function Sam2DArrToMat(_uni, _off) { return new CVec4(0, 0, 0, 0); }
export function Sam2DSize(_off) { return new CVec2(0, 0); }
export function Sam2DArrSize(_off) { return new CVec3(0, 0, 0); }
export function SamCubeSize(_off) { return new CVec2(0, 0); }
export function SamCubeMaxLod(_off) { return 0; }
export function Sam2DArrTileToColor(_number, _uv, _x, _y) { return new CVec4(0, 0, 0, 0); }
export function Sam2DArrTileToNormal(_number, _uv, _x, _y) { return new CVec4(0, 0, 0, 0); }
...
export function TransposeMat4(_a) { return new CMat(0); }
...
export function V3Sqrt(_a) { return new CVec3(0, 0, 0); }
...
export function FloatBitsToInt(_a) { return 0; }
...
export function Hammersley(_idx, _N) { return new CVec2(0, 0); }
export function GridSamplingDisk(_idx) { return new CVec3(0, 0, 0); }
