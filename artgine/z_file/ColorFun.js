...
export var VFX = Null();
export var LUT0 = new Sam2DV4(11, 281);
export var LUT1 = new Sam2DV4(11, 282);
export var LUT2 = new Sam2DV4(11, 283);
export var LUT3 = new Sam2DV4(11, 284);
export var LUT4 = new Sam2DV4(11, 285);
export var LUT5 = new Sam2DV4(11, 286);
function VFXDown0(_uv, _value, _time) {
    ...
    if (_value[1].w < SDF.eColorVFX.None + 0.5) {
        ...
        var ditherStrength = (BayerFilter(screenPos.xy) - 0.5) / (cellSize - 1.0) * _value[0].y;
...
export function VFXDown2(_uv, _value, _time) {
    ...
    if (_value[3].w < SDF.eColorVFX.None + 0.5) {
        ...
        outColor = VFXDown0(_uv, _value, _time);
        var scaledUV = V2DivV2(_uv, new CVec2(_value[2].z, _value[2].z));
        ...
        else if (_value[2].w < 1.5) {
            t = mix(1.0, baseColor.r, _value[2].y);
            outColor.r = outColor.r * t;
        }
        else if (_value[2].w < 2.5) {
            t = mix(1.0, baseColor.r, _value[2].y);
            outColor.g = outColor.g * t;
        }
        else if (_value[2].w < 3.5) {
            t = mix(1.0, baseColor.r, _value[2].y);
            outColor.b = outColor.b * t;
        }
        else if (_value[2].w < 4.5) {
            t = mix(1.0, baseColor.r, _value[2].y);
            outColor.a = outColor.a * t;
        }
        else if (_value[2].w < 5.5) {
        ...
        var palSize = new CVec2(32.0, 32.0);
        var cellSize = floor(pow(palSize.x * palSize.y, 1.0 / 3.0));
        var ditherStrength = (BayerFilter(screenPos.xy) - 0.5) / (cellSize - 1.0) * _value[2].y;
        outColor.rgb = V3AddV3(outColor.rgb, new CVec3(ditherStrength, ditherStrength, ditherStrength));
        var palIndex = MapToPaletteIndex(outColor.rgb, cellSize, palSize);
