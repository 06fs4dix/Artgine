...
export class CTexture extends CObject {
    ...
    EditHTMLInit(_div) {
        ...
        _div.prepend(CDOM.DataToDom({ "tag": "div", "class": "row", "html": [
    ...
    static PackStoredBuf(_buf) {
        if (typeof _buf === "string")
            return _buf;
...
(function (CTexture) {
    ...
    (function (eMipmap) {
        ...
        eMipmap[eMipmap["EnvFilter"] = 3] = "EnvFilter";
