...
export class CCamera extends CObject {
    ...
    GetRay(_worldX, _worldY) {
        ...
        if (this.mOrthographic == false) {
            L_vec.x = ((((_worldX - left) * 2.0) / right - 1.0) - this.mProjMat.mF32A[8]) / this.mProjMat.mF32A[0];
