...
gDesc[SDF.eColorVFX.Scanline]={
    _xDesc:"NumOfLines", _yDesc:"Speed",
    _xMin:0, _xMax:50, _yMin:0, _yMax:10,
    _xStep:5, _yStep:1,
    _xDefault:25, _yDefault:5
};
gDesc[SDF.eColorVFX.ColorPalette]={
    _xDesc:"Index", _yDesc:"Dither",
    _xMin:0, _xMax:10, _yMin:0, _yMax:1,
    _xStep:1, _yStep:0.05, 
    _xDefault:1, _yDefault:0,
};
gDesc[SDF.eColorVFX.Blur]={
    _xDesc:"Type", _yDesc:"Count",
    _xMin:0, _xMax:2, _yMin:0, _yMax:64,
    _xStep:1, _yStep:1, 
    _xDefault:1, _yDefault:1,
};
for(let [text, val] of Object.entries(SDF.eColorVFX)) {
    if(gDesc[val]==null)    gDesc[val]={};

    gDesc[val]["_Name"]=text;
}
