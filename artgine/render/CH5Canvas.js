...
export class CH5Canvas {
    ...
    static FillLinearGradient(stx, sty, edx, edy, color) {
        var cmdList = [];
    ...
    static FillRadialGradient(stx, sty, edx, edy, _stRad, _edRad, color) {
        var cmdList = [];
    ...
    static FillCircle(_centerX, _centerY, _radius, _startAngle = 0, _endAngle = 2 * Math.PI) {
        var cmdVec = [
            CH5Canvas.Cmd("beginPath", []),
    ...
    static StrokeCircle(_centerX, _centerY, _radius, _lineLength, _startAngle = 0, _endAngle = 2 * Math.PI) {
        var cmdVec = [
            CH5Canvas.Cmd("beginPath", []),
            CH5Canvas.Cmd("arc", [_centerX, _centerY, _radius, _startAngle, _endAngle]),
    ...
    static Init(w, h, _linear = true, _exp = true) {
        gCanvas.width = w;
        gCanvas.height = h;
                    ...
                    try {
                        switch (_pVec[i].mParameter.length) {
                            case 0:
                                ...
                                break;
                            case 1:
                                funcDr = funcA(gPara[0]);
                                break;
                            case 2:
                                funcDr = funcA(gPara[0], gPara[1]);
                                break;
                            case 3:
                                funcDr = funcA(gPara[0], gPara[1], gPara[2]);
                                break;
                            case 4:
                                funcDr = funcA(gPara[0], gPara[1], gPara[2], gPara[3]);
                                break;
                            case 5:
                                funcDr = funcA(gPara[0], gPara[1], gPara[2], gPara[3], gPara[4]);
                                break;
                            case 6:
                                funcDr = funcA(gPara[0], gPara[1], gPara[2], gPara[3], gPara[4], gPara[5]);
                                break;
                            case 7:
                                funcDr = funcA(gPara[0], gPara[1], gPara[2], gPara[3], gPara[4], gPara[5], gPara[6]);
                                break;
                            case 8:
                                funcDr = funcA(gPara[0], gPara[1], gPara[2], gPara[3], gPara[4], gPara[5], gPara[6], gPara[7]);
                                break;
                            case 9:
                                funcDr = funcA(gPara[0], gPara[1], gPara[2], gPara[3], gPara[4], gPara[5], gPara[6], gPara[7], gPara[8]);
                                break;
                        }
                        if (ftype == false) {
                            let CH = [];
    ...
    static PushImgData(_buf, _posX, _posY, _bufWidth = 0, _bufHeight = 0) {
        if (_bufWidth == 0)
            _bufWidth = gCanvas.width;
        if (_bufHeight == 0)
            _bufHeight = gCanvas.height;
    ...
    static PushSlicedImgData(_buf, _bufW, _bufX, _bufY, _w, _h) {
        if (_w == 0)
            _w = gCanvas.width;
        if (_h == 0)
            _h = gCanvas.height;
    ...
    static DrawWithCH5File(_cmdList) {
        let cmdVec = [];
