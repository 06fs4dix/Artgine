...
{
    static HSVAToRGBA(_hsva : CVec4, _result : CVec4 = new CVec4()) 
    {
    ...
    static RGBAToHSVA(_rgba : CVec4, _result : CVec4 = new CVec4()) 
    {
    ...
    static HSLAToRGBA(_hsla : CVec4, _result : CVec4 = new CVec4()) {
    ...
    static RGBAToHSLA(_rgba : CVec4, _result : CVec4 = new CVec4()) {
        let [r, g, b] = [_rgba.mF32A[0], _rgba.mF32A[1], _rgba.mF32A[2]];
        let max = Math.max(r, g, b), min = Math.min(r, g, b);
    ...
    static HSLAToHSVA(_hsla : CVec4, _result : CVec4 = new CVec4()) {
    ...
    static HSVAToHSLA(_hsva : CVec4, _result : CVec4 = new CVec4()) {
    ...
    //0 < _brighter < 1
    static BrightenColor(_color : CVec3, _brighter : number) : CVec4 {
        return new CVec4(
            (1.0 - _color.x) * _brighter + _color.x, 
            (1.0 - _color.y) * _brighter + _color.y, 
            (1.0 - _color.z) * _brighter + _color.z, 
            0.0
        );
    }

    static DarkenColor(_color : CVec3, _darker : number) : CVec4 {
        return new CVec4(
            -(1.0 - _color.x) * _darker + _color.x, 
            -(1.0 - _color.y) * _darker + _color.y, 
            -(1.0 - _color.z) * _darker + _color.z, 
            0.0
        );
    }
}