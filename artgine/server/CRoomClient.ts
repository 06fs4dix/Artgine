...
export class CRoomClient extends CSocketIO
{
    ...
    constructor(_local: boolean) 
    {
        ...
        event[CRoomClient.eEvent.RootOwnerConnect] = new CEvent((_stream: CStream) => {
    ...
    async Connect(_pingTime=null): Promise<boolean> {
...
export class CPacRoom
{
    ...
    static SetSUKSend(_sukList : Array<string>,_data,_stream=new CStream())
    {
    ...
    static SetBroadcasting(_header : string,_data,_serverTime=0,_latency=0,_stream=new CStream())
    {
    ...
    static GetRoomDisConnect(_stream : CStream)
    {
    ...
    static GetRoomClose(_stream : CStream)
    {
