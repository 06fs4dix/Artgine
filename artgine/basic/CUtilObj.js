...
export class CUtilObj {
    ...
    static ArrayAddSelectList(_pointer, _body, _input, _valueList, _textArea = false) {
    ...
    static ArrayAddDataList(_pointer, _body, _input, _valueList, _textArea = false, _class = false) {
    ...
    static MapAdd(_pointer, _body, _input, _valueList, _pushFun = null) {
