...
export class CString {
    ...
    static ReplaceAll(_str, searchStr, replaceStr) {
    ...
    static PathArrToFullPath(_path, _backSub = 0) {
        let str = "";
    ...
    static FullPathArrToLastTarget(_target, _pathArr, _startOff = 1) {
    ...
    static InsertAt(str, index, insertStr) {
