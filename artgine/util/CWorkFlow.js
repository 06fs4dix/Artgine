...
export class CWFValue extends CObject {
    ...
    mMember = new Array();
    mListener = null;
    constructor(_data, _listener = null, _member = new Array) {
        super();
        this.mData = _data;
...
export class CWFOperator extends CObject {
    constructor(_op = "false", _value = new Array()) {
        super();
        this.mData = _op;
        this.mValue = _value;
    }
    ...
    ThinParseOperValue(_data, _oper) {
        ...
        let listener1 = null, valueKey1 = null, member1 = new Array();
...
export class CWFCondition extends CObject {
    constructor(_operator = null, _logic = "&&", _next = "") {
        super();
        this.mOperator = _operator;
        if (this.mOperator == null)
            this.mOperator = new Array();
        ;
        this.mLogic = _logic;
        this.mLink = _next;
    }
        ...
        if (this.mCommand.length != 0 && this.IsCall(_delay, _env)) {
            for (let com of this.mCommand) {
                ...
                if (com.mOperator == "=") {
                    ...
                    if (l)
                        l.Set(com.mLeft.mMember, rightRet);
                    else
                    ...
                    var v = l.Get(com.mLeft.mMember);
                    if (v == null)
                        v = 0;
                    if (com.mOperator == "+=")
                        l.Set(com.mLeft.mMember, v + rightRet);
                    else if (com.mOperator == "-=")
                        l.Set(com.mLeft.mMember, v - rightRet);
                    else if (com.mOperator == "*=")
                        l.Set(com.mLeft.mMember, v * rightRet);
...
export class CWFCommand extends CObject {
    ...
    mRightTarget = null;
    mRightFun = null;
    mRightPara = new Array();
    mRightParaTras = new Array();
    mOperator = "";
    IsShould(_member, _type) {
...
export class CWFSystem extends CObject {
    mTaskActive = new Map();
    mLastEnv = null;
    constructor() {
        super();
