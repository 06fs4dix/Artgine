...
export class CPalette {
    ...
    Init(_fw) {
        ...
        for (let y = 0; y < 64; y++) {
            for (let x = 0; x < 64; x++) {
                ...
                if (isX)
                    fa[dstIndex + 0] = tex.GetBuf()[0][srcIndex] / 0xFF;
                else
                    fa[dstIndex + 1] = tex.GetBuf()[0][srcIndex] / 0xFF;
            }
        }
    ...
    SlCompute() { return this.mSLCompute; }
