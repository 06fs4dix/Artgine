...
import { CRendererGL, CRendererGPU } from "../render/CRenderer.js";
import { CDeviceGL, CDeviceGPU } from "../render/CDevice.js";
import { CShaderInterpretGL, CShaderInterpretGPU } from "../render/CShaderInterpret.js";
...
import { CBatchMgrGL, CBatchMgrGPU } from "../render/CBatchMgr.js";
...
export class CFrame {
    ...
    constructor(_pf, _htmlObj = "") {
        ...
        if (typeof _htmlObj == "string") {
            ...
            canDummy.addEventListener("dragover", (e) => {
                e.preventDefault();
            });
            canDummy.addEventListener("dragleave", (e) => {
                e.preventDefault();
            });
            canDummy.addEventListener("drop", async (e) => {
                e.preventDefault();
                if (this.GetEvent(CEvent.eType.Drop).length == 0)
                    return;
                let drop = new CDrop();
                drop.mX = e.offsetX;
                drop.mY = canDummy.height - e.offsetY;
    ...
    async Process() {
        ...
        if (this.mRenderer != null && this.mRenderer.InitGPU != null)
            this.mRenderer.InitGPU();
