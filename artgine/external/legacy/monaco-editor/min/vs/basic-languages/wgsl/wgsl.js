define("vs/basic-languages/wgsl/wgsl", ["require", "require"], (require) => {
    ...
    var moduleExports = (() => {
        ...
        var p = (t, e) => { for (var a in e)
            s(t, a, { get: e[a], enumerable: !0 }); }, d = (t, e, a, o) => { if (e && typeof e == "object" || typeof e == "function")
            for (let i of l(e))
                !u.call(t, i) && i !== a && s(t, i, { get: () => e[i], enumerable: !(o = m(e, i)) || o.enumerable }); return t; };
        var x = t => d(s({}, "__esModule", { value: !0 }), t);
        var F = {};
        p(F, { conf: () => f, language: () => L });
        var f = { comments: { lineComment: "//", blockComment: ["/*", "*/"] }, brackets: [["{", "}"], ["[", "]"], ["(", ")"]], autoClosingPairs: [{ open: "[", close: "]" }, { open: "{", close: "}" }, { open: "(", close: ")" }], surroundingPairs: [{ open: "{", close: "}" }, { open: "[", close: "]" }, { open: "(", close: ")" }] };
        function r(t) { let e = [], a = t.split(/\t+|\r+|\n+| +/); for (let o = 0; o < a.length; ++o)
            a[o].length > 0 && e.push(a[o]); return e; }
        var g = r("true false"), _ = r(`
			  alias
			  break
			  case
			  const
