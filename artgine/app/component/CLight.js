        ...
        if (this.mTexKey != null) {
            ...
            if (this.mShadowOff == false) {
                if (!this.IsPointLight()) {
                    ...
                    const AutoDigitSnapping = (_slook, _texelSize) => {
                        let Zaxis = ligDir;
                    ...
                    for (let i = 0; i < this.mCascadeCycle.length; ++i) {
                        ...
                        seye = CMath.V3AddV3(slook, CMath.V3MulFloat(ligDir, 3 / 2 * size));
