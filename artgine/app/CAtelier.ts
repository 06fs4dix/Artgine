...
import { CUI } from "./subject/CUI.js";
...
export class CAtelier
{
	...
	async Init(_canvas : Array<string>,_canvasHTMLKey="",_devTool=true)
	{
		...
		let script="";
		// if(this.mFrame==CFrame.Main())
		// {
		// 	//이걸 하는 이유는 이벤트는 언제나 마지막에 처리된다는걸 보장하기 위해서다
		// 	CUI.SetMainFrame(this.mFrame);
		// }
...
if(CUtil.IsNode()==false)  	window["CAtelier"]=CAtelier;